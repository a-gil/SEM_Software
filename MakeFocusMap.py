...
def TakeImgs():
    ...
    while k < len(coords):
        ...
        #move stage to that location
        m.StgMoveTo(x, y, z)
        
        #give the stage some time to move
        if k == 0:
            time.sleep(30)
        else:
            time.sleep(5)
...
#and they will be used as the coordinates of the beam's location
    ...
    while x_n <= x_max:                         
        ...
        if x_n > x_max:
            ...
            #increase m index by 1 to down up in y
            m = m + 1
